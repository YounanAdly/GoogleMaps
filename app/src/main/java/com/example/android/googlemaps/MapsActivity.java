...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng giza = new LatLng(30.007133, 31.181712);
        mMap.addMarker(new MarkerOptions().position(giza).title("البنك الاهلي")).showInfoWindow();
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(giza, 16));
